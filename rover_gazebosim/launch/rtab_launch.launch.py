...
def generate_launch_description():
    ...
    config_rtab=os.path.join(get_package_share_directory('rover_gazebosim'),'config','rtab_map_config.ini')
    return LaunchDescription([
        ...
        # Config files
        DeclareLaunchArgument('cfg',      default_value=config_rtab,                        description='To change RTAB-Map\'s parameters, set the path of config file (*.ini) generated by the standalone app.'),
        ...
        DeclareLaunchArgument('odom_topic',                 default_value='/odometry/filtered2',  description='Odometry topic name.'),
