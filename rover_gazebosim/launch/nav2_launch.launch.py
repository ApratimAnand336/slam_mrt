...
#     # points to YOUR config file in YOUR package
#     my_pkg = get_package_share_directory('rover_gazebosim')
...
#             ),
#             launch_arguments={
#                 'params_file': params_file,   # ← YOUR edited yaml
#                 'use_sim_time': 'true',
#                 'autostart': 'true',
#             }.items(),
#         ),
...
def generate_launch_description():
    ...
    map_file = '/home/apratim/maps/my_map_final.yaml'  
